<template>
	<main class="crr--h-screen-minus-header flex">
		<section class="w-full md:w-2/3 mx-auto px-8 lg:px-16 pb-16">
			...
			<ul>
				...
				<li>
					<p>
						...
						Agreement) refers to Falcon Laboratories, 4507 N Sterling Ave #402a Peoria, IL 61615.
					</p>
				</li>
				<li>
			...
			<p>
				...
				<a href="https://www.privacypolicies.com/blog/cookies/">"What Are Cookies"</a> article.
			</p>
			...
			<ul>
				<li>By visiting this page on our website: https://readable.report/contact</li>
			</ul>
		</section>
	</main>
</template>
...
p {
	@apply leading-loose text-sm my-4;
}
</style>
