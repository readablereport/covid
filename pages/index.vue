<template>
	<div>
		...
		<div class="max-w-screen-xl mx-auto pb-10">
			<h1 class="text-6xl font-black text-martinique-500 mt-16">Local COVID-19 info for:</h1>
		...
		<div>
			<div id="map-wrap" class="w-screen" style="height: 80vh;">
				<l-map :zoom="zoom" :center="[40.6936, -89.589]" :options="{ scrollWheelZoom: false }" ref="map">
