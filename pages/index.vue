<template>
    <div>
        ...
        <div class="w-full bg-graph pt-12 relative z-10">
            <div class="max-w-screen-xl mx-auto px-16">
                ...
                <div class="w-full max-w-2xl">
                    <div
                        id="stats"
                        class="flex items-start justify-start mt-8 ml-5"
                    >
                        <!-- <div>
                        ...
                        <div class="leading-loose">
                            ...
                            >
                                {{ this.stats.state.label }} State
                            </h2>
                            <p class="text-sm text-gray-700 font-bold">
                                Confirmed:
                                <span class="text-sm text-gray-600 font-base">{{
                            ...
                            <h2
                                class="text-gray-800 text-xl font-bold capitalize mt-6"
                            >
        ...
        <div
            id="map-wrap"
            class="w-screen h-screen mt-32 absolute top-0 z-0 opacity-25"
        >
            <l-map
                @resize="onResizeMap"
                :zoom="zoom"
